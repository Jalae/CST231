if { ![project_exists {PRIORITY_N_COUNTER}] } {
     project_new {PRIORITY_N_COUNTER}
} else {
     project_open {PRIORITY_N_COUNTER}
}
set_project_settings -cmp {PRIORITY_N_COUNTER}
if { ![project_settings_exist -sim PRIORITY_N_COUNTER] } {
        set_project_settings -sim PRIORITY_N_COUNTER
}
set_global_assignment -section_id {PRIORITY_N_COUNTER} -name {EDA_DESIGN_ENTRY_SYNTHESIS_TOOL} {PRECISION SYNTHESIS}
set_global_assignment -name {EDIF_FILE} {PRIORITY_N_COUNTER.edf}
...
if { [file exists {PRIORITY_N_COUNTER_altera.prop}] } {
  source PRIORITY_N_COUNTER_altera.prop
}
set_global_assignment -name {FAMILY} {MAX7000S}
set_global_assignment -section_id {PRIORITY_N_COUNTER} -name {DEVICE} {EPM7064STC44-10}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
set_global_assignment -name {SDC_FILE} {PRIORITY_N_COUNTER_pnr_constraints.sdc}
